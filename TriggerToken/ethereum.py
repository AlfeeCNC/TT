...
url = "https://goerli.infura.io/v3/ed00ddb25c3b460c9b99f2375a314102"
# Initiating Web3
web3 = Web3(web3.HTTPProvider(url))

# developer's key-pair for sending transactions from backend
developerPublicKey = web3.toChecksumAddress("0x7a0b40Fd34E70255E638961E6e0FFd7777aCd423")
...
# goerli
cashPointAddress = web3.toChecksumAddress("0xc99a01AC3dD5f6479B2EB85a10B8c064944f184c")
cashPointABI = '''[
	{
		"inputs": [
			{
...
cashPointContract = web3.eth.contract(address= cashPointAddress, abi= cashPointABI)